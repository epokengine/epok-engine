...
**Coverage:** 66 headers · 813 public callables.
...
| [Actor Tables](epok/actor-tables.md) | `actor_tables.hpp` | 7 | Epok runtime API |
...
| [Sequence Data](epok/sequence-data.md) | `sequence_data.hpp` | 12 | Epok runtime API |
| [Sequence Kernel](epok/sequence-kernel.md) | `sequence_kernel.hpp` | 11 | Epok runtime API |
| [Sequence Lock](epok/sequence-lock.md) | `sequence_lock.hpp` | 2 | Epok runtime API |
| [Sequence Service](epok/sequence-service.md) | `sequence_service.hpp` | 18 | Epok runtime API |
